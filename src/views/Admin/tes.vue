<template>
  ...
  >
    ...
    >
      ...
      <p v-if="error" class="text-center text-red-500">Lorem ipsum</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-4">
        ...
        >
          <div class="flex items-center space-x-2">
            ...
            <div v-if="postData">
              <p class="font-bold text-3xl">Lorem ipsum</p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div>
              <p class="font-normal text-base">Lorem ipsum</p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="mt-2">
              <p class="font-normal text-base text-pretty">Lorem ipsum</p>
            </div>
          </div>
          <div
            class="items-center gap-2 bg-white rounded-md pt-2 pb-2 ps-2"
          ...
          >
            ...
            <div class="mt-2">
              <p class="font-light text-base text-pretty">Lorem ipsum</p>
            </div>
          </div>
          <div
            class="items-center gap-2 bg-white rounded-md pt-2 pb-2 ps-2"
          ...
          >
            ...
            >
              <p class="font-regular text-base text-pretty">Lorem ipsum</p>
            </div>
          </div>
        </div>
      </div>
