        ...
        >
          ...
          >
            <div class="flex space-x-2 items-center">
              <p class="text-[#3FA2F6] text-xl font-medium">Nama Klinik</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="3"
                height="26"
            ...
            <div>
              <p class="font-regular text-base">Lo Veterinary Clinic</p>
            </div>
          </div>
          ...
          >
            <div class="items-center space-y-1">
              <p class="text-[#3FA2F6] text-xl ps-2 font-medium">Alamat</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="85"
                height="3"
          ...
          >
            ...
            <div class="mt-2">
              <p class="font-regular text-base text-pretty">sadsadsadsad</p>
            </div>
          </div>
