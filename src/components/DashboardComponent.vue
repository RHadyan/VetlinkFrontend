<template>
  <div class="w-full flex items-center flex-col px-2 gap-y-7 mt-5">
    ...
    <div
      class="flex justify-center lg:gap-x-7 sm:gap-x-10 items-center max-w-[300px] sm:max-w-[400px] md:max-w-[500px] lg:max-w-[1190px] shadow-[20px_4px_35px_0px_rgba(0, 0, 0, 0.09)]"
    >
      <div
        class="bg-white w-96 h-48 rounded-[20px] shadow-[20px_4px_35px_0px_rgba(0, 0, 0, 0.1)]"
      >
      ...
      >
        <div class="justify-center items-center flex gap-2 m-5">
          ...
          <p
            class="lg:text-xl text-center sm:text-m font-bold text-[#3FA2F6]"
            style="font-family: 'Poppins', sans-serif"
          >
