    ...
    <nav class="text-white text-base font-semibold pt-3">
      ...
      >
        <svg
          ...
          fill="none"
          :class="{
            'active-svg': isActiveRoute('/hospital'),
            'not-active-svg': !isActiveRoute('/hospital'),
          }"
        >
          <path
            class=""
            d="M19.8333 0H8.16667C6.237 0 4.66667 1.57033 4.66667 3.5V28H23.3333V3.5C23.3333 1.57033 21.763 0 19.8333 0ZM12.8333 22.1667H9.33333V19.8333H12.8333V22.1667ZM12.8333 17.5H9.33333V15.1667H12.8333V17.5ZM10.5 9.33333V7H12.8333V4.66667H15.1667V7H17.5V9.33333H15.1667V11.6667H12.8333V9.33333H10.5ZM18.6667 22.1667H15.1667V19.8333H18.6667V22.1667ZM18.6667 17.5H15.1667V15.1667H18.6667V17.5ZM28 10.5V28H25.6667V7.21467C27.0212 7.69767 28 8.981 28 10.5ZM2.33333 7.21467V28H0V10.5C0 8.981 0.978833 7.69767 2.33333 7.21467Z"
            fill=""
          />
        </svg>
        Hospital
      ...
      >
        <svg
          ...
          fill="none"
          :class="{
            'active-svg': isActiveRoute('/forum'),
            'not-active-svg': !isActiveRoute('/forum'),
          }"
        >
          <path
            class=" "
