    ...
    <nav class="text-white text-base flex flex-col font-semibold">
      ...
      >
        <svg
          ...
          fill="none"
          :class="{
            'active-svg': isActiveRoute('/documentvet'),
            'not-active-svg': !isActiveRoute('/documentvet'),
          }"
        >
          <path
            d="M13.5744 16.3843L10.9676 18.9081C10.5224 19.3527 9.9316 19.5765 9.3394 19.5765C8.7416 19.5765 8.141 19.3486 7.6832 18.8927L6.7298 17.9783C6.1726 17.4428 6.1544 16.5577 6.6906 16.0012C7.2268 15.4447 8.1144 15.4279 8.6702 15.9621L9.3324 16.5983L11.6256 14.3779C12.18 13.8424 13.0662 13.8536 13.6052 14.4086C14.1428 14.9623 14.1302 15.846 13.5744 16.3843ZM19.6 23.7697H15.4C14.6272 23.7697 14 24.3961 14 25.1679C14 25.9398 14.6272 26.5662 15.4 26.5662H19.6C20.3728 26.5662 21 25.9398 21 25.1679C21 24.3961 20.3728 23.7697 19.6 23.7697ZM19.6 6.99109H15.4C14.6272 6.99109 14 7.6175 14 8.38931C14 9.16113 14.6272 9.78753 15.4 9.78753H19.6C20.3728 9.78753 21 9.16113 21 8.38931C21 7.6175 20.3728 6.99109 19.6 6.99109ZM19.6 15.3804H16.8C16.0272 15.3804 15.4 16.0068 15.4 16.7786C15.4 17.5504 16.0272 18.1768 16.8 18.1768H19.6C20.3728 18.1768 21 17.5504 21 16.7786C21 16.0068 20.3728 15.3804 19.6 15.3804ZM9.1 23.0706C7.9408 23.0706 7 24.0102 7 25.1679C7 26.3257 7.9408 27.2653 9.1 27.2653C10.2592 27.2653 11.2 26.3257 11.2 25.1679C11.2 24.0102 10.2592 23.0706 9.1 23.0706ZM9.1 10.4866C10.2592 10.4866 11.2 9.54704 11.2 8.38931C11.2 7.23159 10.2592 6.29198 9.1 6.29198C7.9408 6.29198 7 7.23159 7 8.38931C7 9.54704 7.9408 10.4866 9.1 10.4866ZM28 6.99109V26.5662C28 30.421 24.8598 33.5573 21 33.5573H7C3.1402 33.5573 0 30.421 0 26.5662V6.99109C0 3.1362 3.1402 0 7 0H21C24.8598 0 28 3.1362 28 6.99109ZM25.2 6.99109C25.2 4.67844 23.3156 2.79644 21 2.79644H7C4.6844 2.79644 2.8 4.67844 2.8 6.99109V26.5662C2.8 28.8788 4.6844 30.7608 7 30.7608H21C23.3156 30.7608 25.2 28.8788 25.2 26.5662V6.99109Z"
            fill="#BABABA"
          />
        </svg>
        Status Klinik
