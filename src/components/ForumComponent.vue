          ...
          >
            ...
            <div class="flex font-poppins items-center justify-between m-3">
              ...
              <div>
                ...
                <p class="text-gray-600 text-sm">{{ card.location }}</p>
              </div>
              <div>
...
export default {
  setup() {
    const cards = ref([
      {
        id: 1,
        image: "@/assets/images/Kucing.jpeg",
        username: "namapengguna1",
        location: "Lokasi1",
      },
      {
        id: 2,
        image: "@/assets/images/kucing.jpeg",
        username: "namapengguna2",
        location: "Lokasi2",
      },
      {
        id: 3,
        image: "@/assets/images/kucing.jpeg",
        username: "namapengguna3",
        location: "Lokasi3",
      },
      {
        id: 4,
        image: "@/assets/images/kucing.jpeg",
        username: "namapengguna4",
        location: "Lokasi4",
      },
      {
        id: 5,
        image: "@/assets/images/kucing.jpeg",
        username: "namapengguna5",
        location: "Lokasi5",
      },
      {
        id: 6,
        image: "@/assets/images/kucing.jpeg",
        username: "namapengguna6",
        location: "Lokasi6",
      },
      {
        id: 7,
        image: "@/assets/images/kucing.jpeg",
        username: "namapengguna7",
        location: "Lokasi7",
      },
      {
        id: 8,
        image: "@/assets/images/kucing.jpeg",
        username: "namapengguna8",
        location: "Lokasi8",
      },
    ]);
    ...
    const navigateToDetail = (id) => {
      console.log("Navigasi ke detail dengan ID:", id);
    };
